...
| `SRC-0021` | 2026-09-17 | Excel、PPT与Canvas生态库选型与边界 | 技术选型报告 | Open Source Community | `01-inputs/2026-09-17-excel-ppt-canvas-libraries-research.md` | Go excelize 流式读写、前端 PptxGenJS 原生PPT直出、Marp Markdown汇报与 React Flow 画布 | 已深度分析，确立三端渲染引擎 |
